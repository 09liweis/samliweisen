...
const { samVisuals, getMovieDetail, search, inTheatre, getCelebrities, getSummary, getPhotoDetail, getComments, getReviews, upsertVisual, updateRandomMovie } = require('../controllers/visual.js');
